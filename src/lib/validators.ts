...
export const tenantNotifySchema = z.object({
  ...
  discordWebhookUrl: z.string().max(2048).optional().or(z.literal("")),
  clearDiscordWebhook: z.boolean().optional(),
  smsUrl: z.string().max(2048).optional().or(z.literal("")),
  smsUser: z.string().max(160).optional().or(z.literal("")),
  smsPass: z.string().max(400).optional().or(z.literal("")),
  smsFrom: z.string().max(40).optional().or(z.literal("")),
  smsTo: z.string().max(500).optional().or(z.literal("")),
  ...
  defaultNotifyDiscordOn: z.union([z.array(z.string()), z.string()]).optional(),
  defaultNotifySmsOn: z.union([z.array(z.string()), z.string()]).optional(),
...
export const jobInputSchema = z.object({
  ...
  notifyDiscordOn: notifyListSchema,
  notifySmsOn: notifyListSchema,
  ...
  assertStatus: intField(0, 0, 3650),
